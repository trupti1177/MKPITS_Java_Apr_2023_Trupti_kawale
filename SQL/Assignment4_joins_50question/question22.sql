...
-- 72.	Retrieve the film titles and rental dates for all rentals made by the customer with customer_id 150.
...
inventory.film_id = film.film_id WHERE customer.customer_id = 150