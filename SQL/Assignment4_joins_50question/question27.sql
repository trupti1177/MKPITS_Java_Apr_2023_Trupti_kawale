...
-- 77.	List the film titles and rental dates for all rentals made by customer "HEATHER MORRIS".
...
inventory.film_id = film.film_id WHERE first_name = "HEATHER" AND last_name = "MORRIS"