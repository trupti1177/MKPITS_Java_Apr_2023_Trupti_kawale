...
-- 90.	Display the first name, last name, and email of customers who have rented the film titled "FREAKY POCUS".
...
inventory.film_id = film.film_id WHERE title = "FREAKY POCUS"