...
-- 82.	Display the names of customers who have rented the film titled "FIREBALL PHILADELPHIA".
...
inventory.film_id = film.film_id WHERE title = "FIREBALL PHILADELPHIA"