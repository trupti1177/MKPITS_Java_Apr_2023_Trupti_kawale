...
"                   100%);"
            ...
            out.println("</head>");
            out.println("<body>");
            if(serviceClass.depositAmount(bankApplication)!=0){
                out.println("<h2 align=center class='mt-5'>Amount deposit successfully</h2>");
                ...
                out.println("<h2>Not able to deposit amount</h2>");
            out.println("</body>");
            out.println("</html>");
        }
    }
